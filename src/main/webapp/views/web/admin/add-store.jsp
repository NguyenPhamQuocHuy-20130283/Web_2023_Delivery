...
<<<<<<<< Updated upstream:src/main/webapp/views/web/admin/add-order.html
========
                            <a class="dropdown-item" href="account-info.jsp">
                                <i class="fa fa-user icon"></i> Tài khoản </a>
>>>>>>>> Stashed changes:src/main/webapp/views/web/admin/add-store.jsp
...
<<<<<<<< Updated upstream:src/main/webapp/views/web/admin/add-order.html
                            <a class="dropdown-item" href="../landings/landing/login.html">
                            ...
                            <ul class="sidebar-nav">
                                ...
                                <li>
                                    ...
                                    <ul class="sidebar-nav">
                                        ...
                                        <li>
                                            <a href="add-order.include"> Thêm đơn hàng </a>
                                        </li>
            ...
            <form name="item">
                <div class="card card-block">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" style="width:200px" class="form-control boxed" placeholder="Nhập tên gói hàng">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 form-control-label text-xs-right"> SĐT người gửi: </label>
                        <div class="col-sm-10">
                            <input type="number" style="width:200px" class="form-control boxed" placeholder="Nhập sđt">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 form-control-label text-xs-right"> Địa chỉ giao hàng: </label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control boxed" placeholder="Nhập...">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 form-control-label text-xs-right"> Khoảng cách: </label>
                        <div class="col-sm-10">
