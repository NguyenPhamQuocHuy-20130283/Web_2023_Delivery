...
<body>
  <div class="navbar">
    ...
    <div class="dropdown">
<<<<<<<< Updated upstream:src/main/webapp/views/web/landings/landing/customer_support.html
...
>>>>>>>> Stashed changes:src/main/webapp/views/web/landings/landing/customer_support.jsp
    </div>
    <div class="dropdown">
