...
<div class="navbar">
    ...
    <div class="dropdown">
        ...
        <div class="dropdown-content">
<<<<<<<< Updated upstream:src/main/webapp/views/web/landings/landing/email-verification.html
<<<<<<< Updated upstream:src/main/webapp/views/web/landings/landing/email-verification.jsp
=======
<<<<<<<< Updated upstream:src/main/webapp/views/web/landings/landing/email-verification.html
>>>>>>> Stashed changes:src/main/webapp/views/landings/landing/email-verification.jsp
            <a href="#">Về FedEx</a>
            <a href="#">Tin tức</a>
========
            <a href="about.jsp">Về FedEx</a>
>>>>>>>> Stashed changes:src/main/webapp/views/web/landings/landing/email-verification.jsp
<<<<<<< Updated upstream:src/main/webapp/views/web/landings/landing/email-verification.jsp
=======
========
            <a href="about.jsp">Về FedEx</a>
