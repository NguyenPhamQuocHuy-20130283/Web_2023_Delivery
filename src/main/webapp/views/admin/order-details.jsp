...
<<<<<<<< Updated upstream:src/main/webapp/views/web/admin/order-details.html
                                </ul>
                            </li>
                            <li>
                                <a href="">
...
>>>>>>>> Stashed changes:src/main/webapp/views/web/admin/order-details.jsp
                                    </li>
                                </ul>
                                <ul class="sidebar-nav">
                    ...
                    <div class="order-detail-header ui-title-bar-container max-width-center">
                        <div class="row align-items-start">
                            <div class="col-lg col-sm-12">
                                ...
                                <div><span>Hôm nay 07:51 SA</span>, Kênh giao hàng&nbsp;<strong>web</strong></div>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <table class="ui-table ui-table-vertical-top">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="text-left table-header--money">Tên gói hàng</th>
                                                        <th class="text-left table-header--money">Địa chỉ giao hàng</th>
                                                        <th class="text-left table-header--money">Địa chỉ nhận hàng</th>
                                                        <th class="text-center table-header--money">Khoảng cách(km)</th>
                                                        <th class="text-right table-header--money">Đơn Giá</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                            ...
                                                            <div class="order-block--table">
                                                                <div class="order-block--table-image">
                                                                    <div class="table-cell--image"><img
                                                                            class="box-image"
                                                                            src="../landings/assets/asset 1.jpeg">
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <td class="  align-left text-center">
                                                            <div class="border-0">Bánh kẹo</div>
                                                        </td>
                                                        <td class="  align-left text-center">
                                                            <div class="border-0">TP.HCM</div>
                                                        </td>
                                                        <td class="  align-left text-center">
                                                            <div class="border-0">HN</div>
                                                        </td>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="ui-information-body pb-4">
                                                    <div class="row">
                                                        <div class="col">Số lượng dịch vụ</div>
                                                        <div class="col-auto text-right">2</div>
                                                    </div>
                                                </div>
                                                <div class="ui-information-body pb-4">
                                                    <div class="row">
                                                        <div class="col">Tổng tiền hàng</div>
                                                        <div class="col-auto text-right">600.000₫</div>
                                                    </div>
                                                </div>
                                                <div class="ui-information-body pb-4">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-auto text-right">60.000 ₫</div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="ui-information-body pb-4">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-auto text-right font-weight-bold">540.000 ₫
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="ui-information-body pb-4">
                                ...
                                <div class="omni-layout-card card-default">
                                    ...
                                    <div class="omni-layout-card--header">
                                        <div class="row align-items-center">
                                            <div class="col"><span class="header-title">Thông tin người nhận</span></div>
                                            <div class="col-auto">
                                                <div class="display-none"></div>
                                    ...
                                    <div class="omni-layout-card--section">
                                        <div class="omni-layout-card--section-section">
                                            ...
                                            <p class="mb-0 table-break-word text-nodata">ĐÃ LÊN ĐƠN</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
