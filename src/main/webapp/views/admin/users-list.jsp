                    ...
                    <nav class="menu">
                        <ul class="sidebar-menu metismenu" id="sidebar-menu">
                            ...
                            <li>
                                ...
                                <ul class="sidebar-nav">
<<<<<<<< Updated upstream:src/main/webapp/views/web/admin/users-list.html

                                    <li>
                                        <a href="comments-list.html"> Danh sách báo cáo </a>
========
                                    <li>
                                        <a href="store-list.jsp"> Danh sách cửa hàng </a>
                                    </li>

                                    <li>
                                        <a href="add-store.jsp"> Thêm cửa hàng</a>
>>>>>>>> Stashed changes:src/main/webapp/views/web/admin/users-list.jsp
                                    </li>
                                </ul>
                                <ul class="sidebar-nav">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <h3 class="title"> Danh sách người dùng
                                    <a href="add-users.jsp" class="btn btn-primary btn-sm rounded-s"> Thêm người dùng
                                    </a>
                                ...
                                <div class="item-actions-dropdown">
                                    ...
                                    <div class="item-actions-block">
                                        <ul class="item-actions-list">
                                            ...
                                            <li>
                                                <a class="edit" href="user-editor.html">
