...
<<<<<<<< Updated upstream:src/main/webapp/views/web/admin/user-editor.html
...
>>>>>>>> Stashed changes:src/main/webapp/views/web/admin/user-editor.jsp
                                </ul>
                            </li>
                            <li>
                                <a href="">
            ...
            <article class="content item-editor-page">
                <div class="title-block">
                    <h3 class="title"> Sửa thông tin người dùng
