...
<<<<<<<< Updated upstream:src/main/webapp/views/web/admin/add-comments.html
                            <a class="dropdown-item" href="#">
========
                            <a class="dropdown-item" href="account-info.jsp">
>>>>>>>> Stashed changes:src/main/webapp/views/web/admin/add-comments.jsp
