...
<<<<<<<< Updated upstream:src/main/webapp/views/web/admin/posts-list.html
                                    <a class="dropdown-item" href="#">
========
                                    <a class="dropdown-item" href="account-info.jsp">
>>>>>>>> Stashed changes:src/main/webapp/views/web/admin/posts-list.jsp
                        ...
                        <nav class="menu">
                            <ul class="sidebar-menu metismenu" id="sidebar-menu">
                                    ...
                                    <ul class="sidebar-nav">
                                        <li>
                                            ...
                                            <ul class="sidebar-nav">
                                                ...
                                                <li>
                                                    <a href="item-editor.jsp"> Chỉnh sửa dịch vụ </a>
                                                </li>
                                                <li>
                                        ...
                                        <li>
                                            ...
                                            <ul class="sidebar-nav">
                                                ...
                                                <li>
                                                    <a href="./stars-list.html"> Danh sách đánh giá dịch vụ</a>
                                                </li>
                                            </ul>
                                        </li>
                                    </ul>
                                ...
                                <li>
                                    ...
                                    <ul class="sidebar-nav">
                                        <li>
                                            <a href="charts-morris.html"> Biểu đồ </a>
                                        </li>
                                        <li>
        ...
        <script>
            ...
            },
            {
                ...
                "content": "Bởi là tháng của nàng P&T gửi vô vàn deal ngon giá hời, mời nàng ghé thăm và mua sắm. Ưu đãi toàn bộ dịch vụ từ 10%.",
                "imglink": "news/15"
            },
            {
                "id": "n16",
            ...
            },
            {
                ...
                "content": "Hot deal 11k - hàng ngàn dịch vụ đồng giá",
                "imglink": "news/19"
            },
            {
                "id": "n20",
                ...
                "content": "Sale Off tất cả dịch vụ trong bộ sưu tập mới, cũ, bán chạy. Đồng thời vẫn giảm thêm % chiết khấu cho thẻ VIP",
                "imglink": "news/20"
            }
        ]`);
                                ...
                                <div class="item-actions-dropdown">
                                    ...
                                    <div class="item-actions-block">
                                        <ul class="item-actions-list">
                                            ...
                                            <li>
                                                <a class="edit" href="post-editor.html">
                                                    <i class="fa fa-pencil"></i>
                                                </a>
                                            </li>
                                        </ul>
