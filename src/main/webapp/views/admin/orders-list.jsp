...
<<<<<<<< Updated upstream:src/main/webapp/views/web/admin/orders-list.html
                                <a class="dropdown-item" href="#">
========
                                <a class="dropdown-item" href="account-info.jsp">
>>>>>>>> Stashed changes:src/main/webapp/views/web/admin/orders-list.jsp
                    ...
                    <div class="title-block">
                        <div class="row">
                            <div class="col-md-6">
                                <h3 class="title">
                                    Danh sách đơn hàng
                                    <a href="add-order.jsp" class="btn btn-primary btn-sm rounded-s"> Thêm đơn hàng
                                    </a>
                                    <a href="orders-editor.jsp" class="btn btn-primary btn-sm rounded-s"> Sửa đơn hàng
                                    </a>
...
<!--                                                    </td>-->
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const tableRows = document.querySelectorAll('.ui-table tbody tr');
            ...
            function filterTable() {
                ...
                tableRows.forEach(row => {
                    ...
                    const rowContainsSearchTerm = rowData.some(data => data.includes(searchTerm));
