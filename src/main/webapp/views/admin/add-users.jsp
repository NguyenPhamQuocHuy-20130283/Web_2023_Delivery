...
<<<<<<<< Updated upstream:src/main/webapp/views/web/admin/add-users.html
                            <a class="dropdown-item" href="#">
========
                            <a class="dropdown-item" href="account-info.jsp">
>>>>>>>> Stashed changes:src/main/webapp/views/web/admin/add-users.jsp
...
>>>>>>>> Stashed changes:src/main/webapp/views/web/admin/add-users.jsp
        ...
        <article class="content item-editor-page">
            <div class="title-block">
                <h3 class="title"> Thêm thông tin người dùng
            ...
            <form name="item">
                <div class="card card-block">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control boxed" placeholder="Nhập password">
                        </div>
                    </div>
                    <div class="form-group row">
