                                    ...
                                    <div class="action dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                            <a class="dropdown-item hidden-item" href="#">
                                                <i class="fa fa-pencil-square-o icon"></i>Ẩn cửa hàng</a>
                                            <a class="dropdown-item delete-item" href="#" data-toggle="modal"
                                                data-target="#confirm-modal">
                                                <i class="fa fa-close icon"></i>Xoá cửa hàng</a>
                                        </div>
                                    </div>
                                </h3>
                            </div>
                    ...
                    <ul class="item-list striped">
                        <li class="item item-list-header">
                            <div class="item-row">
                                ...
                                <div class="item-col item-col-header item-col-img md">
                                    <div>
            ...
            for (var i = (page - 1) * records_per_page; i < (page * records_per_page) && i < objJson.length; i++) {
                list.innerHTML += `<li class="item">
                        <div class="item-row">
                            ...
                            <div class="item-col item-col-img md">
                                <h4 class="item-title"> ${objJson[i].boss} </h4>
                                    </a>
                            </div>
                            <div class="item-col fixed pull-left item-col-title">
                                <div class="item-heading">Tên người dùng</div>
                                <div>
                                    <a href="store-editor.html" class="">
                                        <h4 class="item-title"> ${objJson[i].name} </h4>
                                    </a>
                                </div>
                            </div>
                            <div class="item-col item-col-sales">
                                <div class="item-heading">SĐT</div>
                                <div> ${objJson[i].SĐT} </div>
                            </div>
                            ...
                            <div class="item-col item-col-author">
                                ...
                                <div class="no-overflow">
                                    <a href="">${["Khách hàng", "Nhân viên", "Quản lý"][Math.floor(Math.random() * 3)]}</a>
                                </div>
                            </div>
                                ...
                                <div class="item-actions-dropdown">
                                    ...
                                    <div class="item-actions-block">
                                        <ul class="item-actions-list">
                                            ...
                                            <li>
                                                <a class="edit" href="store-editor.html">
