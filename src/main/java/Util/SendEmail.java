...
public class SendEmail {
    static final String from = "sgfdainesend@gmail.com";
    static final String password = "dtgpcnjxhmifbxxs";
    ...
    public static void sendMailFogetPassWord(String addressTo, String MessagePassword) {
        ...
        try {
            ...
            msg.setSubject("Delivery Website - Quên mật khẩu");
    ...
    public static void main(String[] args) {
        sendMailFogetPassWord("chung41901@gmail.com", "KHASasd");
